...
dated$Global_reactive_power <- as.numeric(levels(dated$Global_reactive_power)[dated$Global_reactive_power])
dated$Voltage <- as.numeric(levels(dated$Voltage)[dated$Voltage])
dated$Global_intensity <- as.numeric(levels(dated$Global_intensity)[dated$Global_intensity])
...
par(mfrow=c(2,2))
plot(dated$Time, dated$Global_active_power, xlab="", ylab="Global Active Power", type="l")
plot(dated$Time, dated$Voltage, xlab="datetime", ylab="Voltage", type="l")
...
plot(dated$Time, dated$Global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type="l")
